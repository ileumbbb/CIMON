...
def load_config():
    ...
    """
    parser = argparse.ArgumentParser(description='CIMON_PyTorch')
    ...
    parser.add_argument('-T', '--max-iter', default=150, type=int,
    ...
    parser.add_argument('--num_class', default=70, type=int,
